import './app.css';
import { title } from './constants/enigma-machine';
   ...
   {/* <div class="relative h-full w-full bg-white"><div class="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div></div> */}
    ...
    <div className="container p-2 mx-auto flex justify-between items-center">
        ...
        <div className="text-white space-x-4 md:flex hidden">
           ...
           <img src="buymecoffee-icon.png" height={120} width={120} alt="buymecoffee-icon" />
           </div>
        </div>
...
<h2 className="text-enigmawhite text-2xl font-bold">{title}</h2>
...
<div className="flex-row md:flex gap-3">
  ...
  <div className="rounded-lg w-full md:w-3/4 grid grid-cols-1 gap-3">
    ...
    <div
            className="scrollable-content w-full h-[153px] bg-transparent text-enigmalightgray p-2 rounded-md overflow-auto"
         
        >
          cvsdfvsf India, a land of diverse cultures, traditions, and a rich history, stands as a vibrant tapestry woven with the threads of unity in diversity. Geographically vast and economically dynamic, India is the world's seventh-largest country, home to over a billion people.

In the heart of South Asia, India boasts a kaleidoscope of landscapes, from the towering peaks of the Himalayas to the sun-kissed beaches of Goa. Its history, spanning thousands of years, showcases the rise and fall of empires, the flowering of art and philosophy, and the enduring spirit of resilience. Ancient civilizations like the Indus Valley and the Maurya and Gupta dynasties have left indelible imprints on the nation's heritage.

Modern India is a democratic republic that celebrates the principles of justice, liberty, equality, and fraternity. The country has made significant strides in various fields, including technology, space exploration, and economic development. Cities like Mumbai, Delhi, and Bangalore are bustling hubs of innovation and commerce.

However, India also grapples with challenges such as poverty, inequality, and environmental issues. The nation's commitment to overcoming these challenges is evident in its efforts towards sustainable development and social reforms.

What truly defines India is its people – diverse, resilient, and bound by a collective spirit. The harmonious coexistence of different religions, languages, and traditions exemplifies the nation's motto: "Unity in Diversity." India's cultural tapestry, from classical dances like Bharatanatyam to festivals like Diwali, reflects the country's rich and colorful heritage.

In conclusion, India is a multifaceted nation that encapsulates the essence of tradition and progress. As it navigates the complexities of the modern world, India's journey is a testament to the enduring spirit of a people united by history, culture, and the vision of a brighter future.
        </div>

        <div className='flex border-t border-gray-700 justify-end'>
        <button type="button" class="text-gray-900 mt-2 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-1 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2">

Copy
<svg className='ml-2' width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9 15C9 12.1716 9 10.7574 9.87868 9.87868C10.7574 9 12.1716 9 15 9L16 9C18.8284 9 20.2426 9 21.1213 9.87868C22 10.7574 22 12.1716 22 15V16C22 18.8284 22 20.2426 21.1213 21.1213C20.2426 22 18.8284 22 16 22H15C12.1716 22 10.7574 22 9.87868 21.1213C9 20.2426 9 18.8284 9 16L9 15Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
