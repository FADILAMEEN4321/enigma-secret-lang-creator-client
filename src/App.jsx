...
function App() {
  return (
    <>
      <div class="relative z-10 h-screen md:h-screen lg:h-screen w-full bg-enigmanormalbg">
        <div class="absolute -z-20 h-screen w-full bottom-0left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px]"></div>
        ...
        <div className="flex flex-col items-center justify-center">
          <h1 className="font-bold text-6xl capitalize text-white text-center">
            No one should interfere
            <br /> in your secrets!
          </h1>
          <h4 className="font-semibold mt-4 text-base capitalize text-white text-center">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            <br /> incididunt ut labore et dolore magna aliqua.
          </h4>

          <button className="bg-white px-8 py-2 mt-4 rounded-lg font-semibold">
            Get Started
          </button>
